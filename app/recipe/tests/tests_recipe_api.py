...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_create_recipe_with_existing_tags(self):
        """Test creating a recipe wiht existing tags."""
    ...
    def test_create_recipe_with_existing_ingredients(self):
        """Test creating a new recipes with existing ingredients."""
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title="Some recipe 1")
        r2 = create_recipe(user=self.user, title="Some recipe 2")
        ...
        r3 = create_recipe(user=self.user, title="Some recipe 3")
